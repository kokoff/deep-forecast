...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{../stationary_tests/ea_CPI.csv}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{../stationary_tests/ea_GDP.csv}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{../stationary_tests/ea_UR.csv}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{"../stationary_tests/ea_IR Policy Rate.csv"}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{"../stationary_tests/ea_LR10.csv"}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{"../stationary_tests/ea_LR10-IR.csv"}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{"../stationary_tests/ea_Exrate Euro for 1 USD.csv"}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{../stationary_tests/us_CPI.csv}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{../stationary_tests/us_GDP.csv}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{../stationary_tests/us_UR.csv}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{"../stationary_tests/us_IR FEDFUNDS.csv"}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{"../stationary_tests/us_IR10 premium.csv"}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{"../stationary_tests/us_LR10 - IR.csv"}
...
\begin{table}[h!]
\centering
\csvautotabular[respect all]{"../stationary_tests/us_Exrate USD to 1 Euro.csv"}
