...
OUTPUT_PATH = os.path.join(os.path.basename(os.path.realpath(__file__)), '..', '..', 'experiments', 'python-analysis')
...
def stationary_tests(data):
    ...
    for variable in data.columns:
        ...
        file_path = os.path.join(OUTPUT_PATH, 'stationary-tests', variable + '')
        results.to_csv()
